from preprocessing import load_image_paths, balance_classes, split_data
...
def main():
    ...
    # Cargar y balancear las imágenes
    df = load_image_paths(bac_minus_folder, bac_plus_folder)
    oversampled_df = balance_classes(df)

    # Dividir los datos en entrenamiento, validación y prueba
    train_df, valid_df, test_df = split_data(oversampled_df)
    ...
    save_model(learn, model_name='oversampling_vgg.pkl')
